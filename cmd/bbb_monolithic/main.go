...
func main() {
	...
	inputFileExposer := builder.NewHardlinkingInputFileExposer(builder.NewBlobAccessInputFileExposer(contentAddressableStorage), util.KeyDigestWithoutInstance, "/cache")
